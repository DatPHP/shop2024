                        ...
                        <div className="dis-none panel-filter w-full p-t-10">
                            <div className="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                                ...
                                <div className="filter-col3 p-r-15 p-b-27">
                                    ...
                                    <ul>
                                        <li className="p-b-6">
                                            <span className="fs-15 lh-12 m-r-6 brand-product-1">
                                        ...
                                        <li className="p-b-6">
                                            <span className="fs-15 lh-12 m-r-6 brand-product-2" >
                                                <i className="zmdi zmdi-circle"></i>
                                            </span>
                                        ...
                                        <li className="p-b-6">
                                            <span className="fs-15 lh-12 m-r-6 brand-product-3">
                                                <i className="zmdi zmdi-circle"></i>
                                            </span>
                                        ...
                                        <li className="p-b-6">
                                            <span className="fs-15 lh-12 m-r-6 brand-product-4" >
                                                <i className="zmdi zmdi-circle"></i>
                                            </span>
                                        ...
                                        <li className="p-b-6">
                                            <span className="fs-15 lh-12 m-r-6 brand-product-5">
                                                <i className="zmdi zmdi-circle"></i>
                                            </span>
                                        ...
                                        <li className="p-b-6">
                                            <span className="fs-15 lh-12 m-r-6 brand-product-6">
